...
\card{79}{Bestimmen Sie die effektive Strahlungsleistung bei folgenden Gegebenheiten: Senderleistung: \SI{200}{\watt}; Dämpfung der Antennenleitung: \SI{6}{\dB}/\SI{100}{\metre}; Kabellänge: \SI{50}{\metre}; Gewinn: \SI{10}{\dB}d (Werte sind variabel)}{
  \item
  ...
  \item
  Strahlungsleistung ist für einzuhaltende Grenzwerte wichtig!
}
\card{80}{Bestimmen Sie die effektive Strahlungsleistung bei folgenden Gegebenheiten: Senderleistung \SI{100}{\watt}; Dämpfung der Antennenleitung \SI{12}{\dB}/\SI{100}{\metre}; Kabellänge \SI{25}{\metre}; Rundstrahlantenne mit Gesamtwirkungsgrad von \SI{50}{\percent} (Werte sind variabel)}{
  \small
  \item
  Unklar ob Dipol oder Isotropstrahler. Nehmen wir Isotropstrahler an, daher ist EIRP zu berechnen. Beachte, dass ein \emph{Wirkungsgrad} gegeben ist. Kein Antennen\emph{gewinn} wie bei Frage~79.

  \item
  effektive Kabeldämpfung = $-12\cdot (25/100) = \SI{-3}{\dB}$ \\
  daher Leistungsfaktor = $0.5$ \\
  daher Leistung an Antenne = $\SI{100}{\watt} \cdot 0.5 = \SI{50}\watt$ \\
  Antennengewinn als Leistungsfaktor = $\SI{50}{\percent} \Rightarrow 0.5$ \\
  $\text{EIRP} = \SI{50}{\watt} \cdot 0.5 = \SI{25}{\watt}$ \\
  {\footnotesize ($\text{ERP} = 25 / 1.64 = \SI{15.2}{\watt}$)}
...
\card{04}{Kenngrößen einer Gleichstromquelle}{
  Die Spannung ist konstant, Polarität verändert sich nicht.
